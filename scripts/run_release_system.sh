...
tmux send-keys -t $SESSION:0.1 "cd '$CURRENT_DIR' && ./build/Release/matching_engine/src/MatchingEngineServer" Enter
tmux send-keys -t $SESSION:0.2 "cd '$CURRENT_DIR' && q -p 9788 database/tradesdb" Enter
